    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div>
        ...
        <div className='w-full'>
          ...
          <input onChange={(e) => setName(e.target.value)} value={name} type="text" className='w-full max-w-[500px] px-3 py-2' />
        </div>
        ...
        <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
          ...
          {/* subCategory */}
          <div>
            <p className='mt-3 mb-2'>Sub category</p>
        ...
        <div>
          <p className='mt-3 mb-2'>Product Sizes</p>
